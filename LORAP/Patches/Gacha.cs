...
namespace LORAP.Patches
{
    ...
    {
        // UIBattleResultPanel patch. Generate Gacha Drops and Send AP Checks when burning a book. // OBSOLETE!!!!!!!!!!!!!
        ...
        // UIShowUsingBookInfoPanel patches. Add "Burn and see ;)" text to book burning menu. // TODO: Change it only for Book of Everything (Maybe random items animation?)
